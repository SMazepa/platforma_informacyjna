...
--
-- Host: 127.0.0.1
-- Czas generowania: 25 Sty 2019, 18:44
...
--
ALTER TABLE `artykul`
  MODIFY `art_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=37;
...
--
ALTER TABLE `statystyka`
  MODIFY `stat_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=41;
